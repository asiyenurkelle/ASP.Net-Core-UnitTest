...
namespace UdemyRealWordUnitTest.Web.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,Price,Stock,Color,Id")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Edit(int id, [Bind("Name,Price,Stock,Color,Id")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
