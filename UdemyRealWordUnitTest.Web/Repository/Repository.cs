...
{
    //Tentity'e product verirsek product tablosu set edilcek baska birşey verirsek o.
    public class Repository<TEntity> : IRepository<TEntity> where TEntity : class
    {

        private readonly UdemyUnitTestDbContext _context;
        private readonly DbSet<TEntity> _dbSet;
        //update,delete,create işlemlerinde dbset üzerinden gerçekleştirip,context üzerinden db'e gönderdik.
